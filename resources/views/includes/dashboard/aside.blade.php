...
<div
    id="sidebar"
    class="bg-putih h-fit md:block shadow-xl px-3 w-30 md:w-60 lg:w-60 overflow-x-hidden transition-transform duration-300 ease-in-out"
    x-show="sidenav"
    ...
    <div class="space-y-6 md:space-y-10 mt-10">
        ...
        <div id="menu" class="flex flex-col space-y-2">
            ...
            @if (Auth::check())
            <form method="POST" action="{{ route('logout') }}" class="text-sm font-medium text-gray-700 py-2 px-2 hover:bg-teal-500 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out">
                @csrf
                <a
                    href="{{ route('logout') }}"
